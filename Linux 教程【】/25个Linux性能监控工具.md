...
![img](http://s8.51cto.com/wyfs02/M02/57/2A/wKioL1STlVKAFzKZAAB_43PotoU883.jpg)
...
**更多信息**请参考[安装和配置lcinga文章](http://linoxide.com/monitoring-2/install-configure-icinga-linux/)。
